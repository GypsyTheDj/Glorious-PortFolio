...
As with all projects, all contributors to a pull request must have an Glorious-PortFolio CLA (Contributor License Agreement) on file before it can be merged. Here, a contributor is defined as the author of a git commit.
